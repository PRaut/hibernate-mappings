...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.Controller.prototype, /** @lends Chart.Controller */ {
		...
		resize: function(silent) {
			...
			var newWidth = 700;// helpers.getMaximumWidth(canvas);
			var aspectRatio = chart.aspectRatio;
			var newHeight = 400;//(me.options.maintainAspectRatio && isNaN(aspectRatio) === false && isFinite(aspectRatio) && aspectRatio !== 0) ? newWidth / aspectRatio : helpers.getMaximumHeight(canvas);
