...
<body ng-app="charts" id="top">
	<div class="container">
		<section id="charts">
			...
			<div class="row">
				<div class="col-lg-4 col-sm-12" id="line-chart"
				...
				<div class="col-lg-4 col-sm-12" id="bar-chart"
				...
				<div class="col-lg-4 col-sm-12" id="doughnut-chart"
			...
			<div class="row">
				<div class="col-lg-4 col-sm-12" id="radar-chart"
				...
				<div class="col-lg-4 col-sm-12" id="pie-chart"
				...
				<div class="col-lg-4 col-sm-12" id="polar area-chart"
